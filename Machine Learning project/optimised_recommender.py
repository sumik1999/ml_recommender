# recommender_semantic.py (Optimized Version)
# Requirements:
...
def demo():
    ...
    user_profile = {
        "User_course_interest": ["Human Behaviour", "Organizational Psychology","Leadership Skills","Conflict Resolution"],
        "User_career_interest": "Human resources management",
